...
For the sake of showing you how proxmox looks when launching the install I used [Oracle VirtualBox](https://www.virtualbox.org/) to create a VM with Proxmox iso file. As you can see in Example 1.1 I created a VM in VirtualBox with 300gb of storage that proxmox is installing on. My real proxmox is on an entire HDD dedicated to proxmox only.
